...
class ConfigContent {
  ...
  ConfigContent.fromJson(Map<String, dynamic> json) {
    ...
    _subscriptionFreeTrailPeriod =
        int.tryParse(json['free_trial_period'].toString());
    _subscriptionFreeTrailType = json['free_trial_type'];
    _subscriptionDeadlineWarning =
        int.tryParse(json['deadline_warning'].toString());
    _providerCanCancelBooking =
        int.tryParse(json['provider_can_cancel_booking'].toString());
    _providerCanEditBooking =
        int.tryParse(json['provider_can_edit_booking'].toString());
    _currencySymbolPosition = json['currency_symbol_position'];
    _providerSelfRegistration =
    ...
    _defaultCommission = json['default_commission']?.toString();
    ...
    _minimumWithdrawAmount =
        double.tryParse(json['minimum_withdraw_amount'].toString());
    _minimumPayableAmount =
        double.tryParse(json['min_payable_amount'].toString());
    _maximumWithdrawAmount =
        double.tryParse(json['maximum_withdraw_amount'].toString());
    _showPhoneNumber =
        int.tryParse(json['phone_number_visibility_for_chatting'].toString());
    _bidOfferVisibilityForProvider =
        int.tryParse(json['bid_offers_visibility_for_providers'].toString());
    ...
    _forgetPasswordVerificationMethod =
        json['forgot_password_verification_method'] != null
            ...
            : null;
    _bookingOtpVerification =
        int.tryParse(json['booking_otp_verification'].toString());
    _bookingImageVerification =
        int.tryParse(json['service_complete_photo_evidence'].toString());
    ...
    _maxCashInHandLimit =
        double.tryParse(json['max_cash_in_hand_limit_provider'].toString());
    _suspendOnCashInHandLimit =
        int.tryParse(json['suspend_on_exceed_cash_limit_provider'].toString());
    ...
    _providerCanReplyReview =
        int.tryParse(json['provider_can_reply_review'].toString());
