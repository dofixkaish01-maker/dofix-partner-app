              ...
              return Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // ================= ERROR TEXT =================
                    if (enteredAmount > 0 && enteredAmount < minWithdraw) ...[
                    ...
                    // ================= CATEGORY NOTE =================
                    Obx(() {
                      final category = controller.categoryInfo.value;
                    ...
                    if (controller.selectedWithdrawMethod != null)
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: controller.selectedWithdrawMethod
                                  ?.methodFields?.first.placeholder ??
                              '',
                          labelText: controller.selectedWithdrawMethod
                                  ?.methodFields?.first.placeholder ??
                              '',
                          labelStyle: TextStyle(
                            color: primaryAppColor,
