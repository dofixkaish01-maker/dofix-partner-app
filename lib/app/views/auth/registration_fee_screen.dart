...
// import 'package:universal_html/js.dart'; // Unused
...
// import '../payment/payment_failed_screen.dart'; // Currently unused
// import '../payment/payment_success_screen.dart'; // Currently unused
...
class RegistrationFeeScreen extends StatelessWidget {
          ...
          child: Obx(() {
            ...
            return SingleChildScrollView(
              ...
              padding: EdgeInsets.fromLTRB(
                ...
                isTablet ? 24 : 18,
                horizontalPadding,
                140, // bottom bar ke liye extra space
              ),
              child: Center(
  ...
  // ================= TOP TEXT =================
  Widget _topMessage(BuildContext context) {
  ...
  // ================= INFO BOX =================
  Widget _infoMessage(BuildContext context) {
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: const [
                  ...
                  TextSpan(text: "hai. Payment ke baad aapka "),
                  TextSpan(
                  ...
                  ListTile(
                    ...
                    onTap: () async {
                      ...
                      await authCtrl.userWalletRecharge(
                        ...
                        providerId: dashCtrl.providerDashboardModel.content
                                ?.providerInfo?.id ??
                            "",
                      );
